...
class SocialNetworkTest {
    ...
    @Test
    public void testFindFirstByStream() {
        SocialNetwork socialNetwork = new SocialNetwork(Arrays.asList(
                new Member("John Doe", Arrays.asList("Java", "OOP"), Sex.MALE),
                new Member("Jane Doe", Arrays.asList(".NET", "OOP"), Sex.FEMALE),
                new Member("James Doe", Arrays.asList("Python", "Java", "OOP"), Sex.MALE),
        ...
        assertFalse(socialNetwork.findFirstByStream(m -> m.getName().equals("Joe")).isPresent());

        assertTrue(socialNetwork.findFirstByStream(m -> m.getName().equals("John Doe")).isPresent());
        assertEquals("John Doe", socialNetwork.findFirstByStream(m -> m.getName().equals("John Doe")).get().getName());
    }
    ...
    public void testAvgByStream() {
        assertEquals(false, new SocialNetwork(Collections.emptyList()).averageNumberOfSkillsByStream().isPresent());
        ...
        assertEquals(2.25, socialNetwork.averageNumberOfSkillsByStream().get());
    }
}